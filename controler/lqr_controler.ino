...
float[] Kalman = {0.1, 0.1, 0.1, 0.1};
float[] lqr = {0.1, 0.1, 0.1, 0.1};
float error = 0;
int direction = 0;
...
// A x B = C
// A, B, C: pointers to the first element of the matrices
// m: number of rows in A and C
// n: number of columns in A and rows in B
// p: number of columns in B and C
// This function multiplies two matrices A and B and stores the result in C
